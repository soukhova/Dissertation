...
cap_value <- quantile(access_WALK_i$V_i_0, 0.95, na.rm = TRUE)
access_WALK_i$V_i_0_capped <- pmin(access_WALK_i$V_i_0, cap_value)
cap_value <- quantile(access_WALK_i$V_tot_i, 0.95, na.rm = TRUE)
access_WALK_i$V_tot_i_capped <- pmin(access_WALK_i$V_tot_i, cap_value)
cap_value <- quantile(access_WALK_i$V_opp_i, 0.95, na.rm = TRUE)
...
access_WALK_i$V_i_0_quart <- cut(access_WALK_i$V_i_0_capped, 
                                 breaks = breaks_V_i_0, 
                                 include.lowest = TRUE, 
                                 labels = c("Q1", "Q2", "Q3", "Q4"))

access_WALK_i$V_tot_i_quart <- cut(access_WALK_i$V_tot_i_capped, 
                                   breaks = breaks_V_tot_i, 
                                   include.lowest = TRUE, 
                                   labels = c("Q1", "Q2", "Q3", "Q4"))

access_WALK_i$V_opp_i_quart <- cut(access_WALK_i$V_opp_i_capped, 
...
ggplot(summary_long, aes(x = reorder(park_size, -Value), y = Value, fill = Measure)) +
  ...
  labs(y = "Accessible Population / Sqm of Parkland", x = "", fill = "") +
  theme_minimal()  +
