...
In sum, Figure\,\ref{fig:chp5-WALK_parkland_percapita_comparison_scatter} highlights the value of applying constraints: despite differences in how the unimodal and multimodal measures are calculated, the same underlying walking behaviour is used in both measures so results \emph{should} be related: and they are.
