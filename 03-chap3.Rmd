...
##### Potentially accessible parkland: constrained to the total supply of parkland
...
##### Potentially accessible population: constrained to the total demanding population
...
##### Potentially accessible parkland: constrained to the total and marginal supply of parkland 
...
##### Potentially accessible population: constrained to the total and marginal demanding population
...
##### Potentially reachable parkland by modal-qualities of population: constrained to the total of parkland
...
##### Potentially reachable population by modal-qualities of parks: constrained to the total demanding population
...
##### Potentially reachable parkland by modal-qualities of population: constrained to the total and marginal supply of parkland
...
##### Potentially reachable population by modal-qualities of parks: constrained to the total and marginal demanding population
...
This can likewise be applied to market potential. Referring to **accessible population**, i.e., summaries of $M_{ji}^T$ & $M_{ji}^{mT}$, and $M_{ji}^{S}$ & $M_{ji}^{mS}$, are represented per capita and aggregated at different zonal levels to reflect **potential population serviced**.
